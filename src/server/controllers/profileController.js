...
exports.register = async (req, res) => {
  try {
    ...
    await sendMail(email, 'Welcome to ESMOLOG Worldwide Cargo and Logistics', `<p>Hi ${name}, welcome to ESMOLOG Worldwide Cargo and Logistics!</p>`);
  ...
  try {
    ...
    await sendMail(userToUpdate.email, 'Your Password Has Been Changed',
      `<p>Hi ${userToUpdate.name},</p>
       <p>Your password for ESMOLOG Worldwide Cargo and Logistics account has been changed by an administrator.</p>
