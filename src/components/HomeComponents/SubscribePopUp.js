        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[999999]'>
          <div className='bg-white rounded-lg shadow-lg p-8 max-w-md w-full'>
            <div className='flex flex-col items-center'>
                ...
                <div className='text-center text-sm text-gray-600'>Enter your email to get the update on ESMOLOG Worldwide Cargo and Logistics&apos;s hottest deals, exclusive offers, early access to shipments and more.<br />Don&apos;t miss out</div>
